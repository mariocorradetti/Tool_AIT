...
class DataAnalyzer:
    ...
    # ============================================================
    def plot_with_cursors(self, df, x_col, y_col1, y_col2=None, title=None, xlabel=None, ylabel=None, ylabel2=None):
            ...
            if y2 is not None:
                ...
                label_to_use = ylabel2 if ylabel2 else y_col2
                ax2.set_ylabel(label_to_use, color='tab:red', fontweight='bold')
