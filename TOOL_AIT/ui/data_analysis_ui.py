...
class DataAnalysisUI(tb.Frame):
    ...
    def show_column_selectors(self):
        ...
        tb.Label(self.frame_controls, text="Asse Y2").grid(row=6, column=0, sticky=W, pady=5)
        self.y2label_entry = tb.Entry(self.frame_controls, width=32)
        self.y2label_entry.grid(row=6, column=1, pady=5)
    ...
    def plot_data(self):
        ...
        y2label = self.y2label_entry.get().strip()
